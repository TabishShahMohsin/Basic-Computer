...
* By the end of this, the computer should be able to do
    * Fibonacci(x)
    * x!
    * Bubble Sort
...
├── README.md
└── src/
    ├── 00-Digital Logic Combinational and Sequential Circuits/    # The building blocks for the ALU and Bus with Memory elements and counters
    │   ├── HalfAdder.circ
    │   ├── FullAdder.circ
    │   ├── 4BitAdder.circ
    │   ├── 16BitAdder.circ
...
### Good to remember Logisim shortcuts: 😅
...
| **View** | Zoom In | `Ctrl` + `+` | `Cmd` + `+` | Not working with mac 
